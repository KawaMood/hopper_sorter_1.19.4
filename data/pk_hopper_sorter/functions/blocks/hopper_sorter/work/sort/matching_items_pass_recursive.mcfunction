...
execute align xyz run summon area_effect_cloud ~0.5 ~-0.1 ~0.5 {Duration:26,Age:0,WaitTime:-1,Tags:["pk.ho_so","pk.ho_so.hopper_sorter","pk.ho_so.hopper_sorter.item_holder"],Passengers:[{id:"minecraft:item",Tags:["pk.temp.current.item"],PickupDelay:1,Item:{id:"minecraft:stick",Count:1b}}]}
