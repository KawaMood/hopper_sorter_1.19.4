...
execute if block ~ ~ ~ player_wall_head[facing=north] run scoreboard players set $facing pk.temp 0
# North (1)
...
execute if block ~ ~ ~ player_wall_head[facing=south] run scoreboard players set $facing pk.temp 1
# West (2)
...
execute if block ~ ~ ~ player_wall_head[facing=east] run scoreboard players set $facing pk.temp 2
# East (3)
...
execute if block ~ ~ ~ player_wall_head[facing=west] run scoreboard players set $facing pk.temp 3