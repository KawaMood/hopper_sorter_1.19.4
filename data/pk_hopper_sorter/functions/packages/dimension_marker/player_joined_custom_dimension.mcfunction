#> pk_hopper_sorter:packages/dimension_marker/player_joined_custom_dimension
# Check if there is already a dimension mark entity in this custom dimension

advancement revoke @s only pk_hopper_sorter:packages/dimension_marker/joined_custom_dimension
